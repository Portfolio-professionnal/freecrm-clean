      ...
      <nav className="bg-white shadow-sm">
        ...
        <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link href="/clients" className="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
              Clients
            </Link>
            <Link href="/prospects" className="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
              Prospects
            </Link>
            <Link href="/taches" className="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
              Tâches
            </Link>
            <Link href="/factures" className="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
              Factures
            </Link>
            <button
              onClick={signOut}
        ...
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link href="/clients" className="font-medium text-blue-700 hover:text-blue-900">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link href="/prospects" className="font-medium text-blue-700 hover:text-blue-900">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Tâches</dt>
                      <dd>
                        <div className="text-lg font-medium text-gray-900">0</div>
                      </dd>
                    </dl>
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link href="/taches" className="font-medium text-blue-700 hover:text-blue-900">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link href="/factures" className="font-medium text-blue-700 hover:text-blue-900">
